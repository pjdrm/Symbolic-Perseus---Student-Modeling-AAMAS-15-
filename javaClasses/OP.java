...
class OP {
    ...
    public static double factoredExpectationSparseNoMemRecursive(DD[] factDistArray, DD dd) {
				...
				// it's a leaf
                int varId = dd.getVar();
				//System.out.println("varId " + varId + " " + factDistArray.length);
				if (varId == 0) 
						return dd.getVal();
    ...
    public static double[][] factoredExpectationSparseNoMem(DD[][] factDist, DD[] ddArray) {
                ...
                for (int i=0; i<factDistArray.length; i++)  {    
				    for (int j=0; j<ddArray.length; j++) {
						/*System.out.println("factDist ");
						factDistArray[i][j].display();
						System.out.println("ddArray ");
						ddArray[j].display();*/
	...
	//////////////////////////////////////////////////////
		...
		System.out.println("***********");
		dd.display();
		for(int i = 0; i < dd.getVarSet().length; i++){
			System.out.println("V" + i + ": " +dd.getVarSet()[i]);
		}
		System.out.println("-----------");
